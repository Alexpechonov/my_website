...
<head>
    ...
    {{ Html::style('css/faq/reset.css') }}
    {{ Html::style('css/faq/style.css') }}
    {{ Html::script('js/faq/modernizr.js') }}
    <title>{{ config('app.name', 'Community BSUIR') }} - FAQ</title>
</head>
<body>
<header>
    <h1>{{ config('app.name', 'Community BSUIR') }} - FAQ</h1>
</header>
...
{{ Html::script('js/faq/jquery.mobile.custom.min.js') }}
{{ Html::script('js/faq/main.js') }}
</body>
</html>